...
object NetworkModule {
    ...
    @Provides
    @Singleton
    @Named("FRIENDSHIP_RETROFIT")
    fun provideFriendshipRetrofit(
        client: OkHttpClient,
        @Named("FRIENDSHIP_BASE_URL") baseUrl: String
    ): Retrofit = Retrofit.Builder()
        .client(client)
        .baseUrl(baseUrl)
        .addConverterFactory(GsonConverterFactory.create())
    ...
    @Provides
    @Singleton
    fun provideFriendshipApi(@Named("FRIENDSHIP_RETROFIT") retrofit: Retrofit): FriendshipApi =
